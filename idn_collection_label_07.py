...
class IdnCollectionRate:
    ...
    def get_data(self):
        ...
        where u.uid = b.uid
        and (b.repayment_month < '""" + self.this_month + """' or b.repayment_month = '""" + self.this_month + """-07')
        group by u.uid;
    ...
    def process_data(self, dataframe, list_a):
        ...
        final_df = df[['uid', 'collection_rate', 'non_paid', 'registered_city', 'shipping_address_city',
                       'latest_shipping_address', 'default_shipping_address', 'registered_address']][
            (df.repay_allbill < 1)]
